...
import static io.newl.inventory.domain.DepartmentTestSamples.*;
import static io.newl.inventory.domain.EmployeeTestSamples.*;
import static io.newl.inventory.domain.EmployeeTestSamples.*;
import static io.newl.inventory.domain.JobHistoryTestSamples.*;
import static io.newl.inventory.domain.JobTestSamples.*;
