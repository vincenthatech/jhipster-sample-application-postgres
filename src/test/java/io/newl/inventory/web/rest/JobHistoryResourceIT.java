...
import static io.newl.inventory.domain.JobHistoryAsserts.*;
import static io.newl.inventory.web.rest.TestUtil.createUpdateProxyForBean;
...
import io.newl.inventory.domain.JobHistory;
import io.newl.inventory.domain.enumeration.Language;
import io.newl.inventory.repository.JobHistoryRepository;
