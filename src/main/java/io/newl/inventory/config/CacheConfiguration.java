package io.newl.inventory.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.newl.inventory.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.newl.inventory.repository.UserRepository.USERS_BY_EMAIL_CACHE);
