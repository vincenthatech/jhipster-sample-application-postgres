...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.country.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
