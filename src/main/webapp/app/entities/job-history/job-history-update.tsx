  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationPostgresApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationPostgresApp.jobHistory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate(`jhipsterSampleApplicationPostgresApp.Language.${language}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="job"
                data-cy="job"
                label={translate('jhipsterSampleApplicationPostgresApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterSampleApplicationPostgresApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipsterSampleApplicationPostgresApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
