...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
