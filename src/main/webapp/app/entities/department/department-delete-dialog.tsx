...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.department.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
