...
export const JobDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.job.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
