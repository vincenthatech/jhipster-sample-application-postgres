...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.task.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
