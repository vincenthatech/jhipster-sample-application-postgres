...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.region.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
