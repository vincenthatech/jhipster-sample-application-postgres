...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.employee.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
