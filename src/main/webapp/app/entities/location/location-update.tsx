  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationPostgresApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationPostgresApp.location.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationPostgresApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('jhipsterSampleApplicationPostgresApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
