...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationPostgresApp.location.delete.question">
        <Translate contentKey="jhipsterSampleApplicationPostgresApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
